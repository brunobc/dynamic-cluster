...
A figura \ref{fig:sad} apresenta a representação do modelo metodológico (metodologia) empregada para tornar factível a leitura, armazenamento, visualização e análise de dados espaço-temporais. A \ref{fig:metodologia} representa o \acrshort{SAD} dessa metodologia nos casos de dengue e chikungunya, utilizando o Dynagraph para análise dos dados e a base de dados do \citeonline{simda}.
...
% Incluir na discussão o motivo de utilizar os valores/parâmetros nos testes - 1km, 500m...
...
\begin{figure}[!ht]
	\centering	
	\Caption{\label{fig:stdbscan2019dengue250} ST-DBSCAN: Dengue/2019, 4 semanas, Eps=250m, MinPts=2}
	\UECEfig{}{
...
% Incluir imagem com grupos dos dois algoritmos de uma semana qualquer e com relatórios ao lado
As figuras \ref{fig:resultadoSemana132017} e \ref{fig:resultadoSemana132017Comparativo} representam os resultados de predição espaço-temporal na semana 13 do ano de 2017, sobre ocorrência de casos humanos de dengue nos algoritmos ST-DBScan e ST-IGN.
% Discussão:

\begin{figure}[!ht]
	\centering	
	\Caption{\label{fig:resultadoSemana132017Comparativo} Resultados ST-DBSCAN e ST-IGN: Dengue - 2017 Semana 13}
	\UECEfig{}{
...
\begin{figure}[!ht]
	\centering	
	\Caption{\label{fig:resultadoSemana132017} Resultados ST-DBSCAN e ST-IGN: Dengue - 2017 Semana 13}
	\UECEfig{}{
...
% Discutir resultados mostrados no gráfico de barra;
% Analisar qual o "melhor" algoritmo
% Descrever função objetivo e incluir nas discussões
% Discussão em STCrime_ComparisonofMethods / GeoComputacionalSTAlgorithm_DENGUETAIWAN__NATURE / GeoComputacionalSTAlgorithm_DENGUETAIWAN__NATURE_IMPORTANTE
% Os resultados obtidos sugerem que...

% analisar se hipóteses correspondem a conclusão:
%   É viabilizado o armazenamento dos dados por uma ferramenta de extração e armazenamento de dados automatizada seguindo a estrutura de dados do Dynagraph.
%   É exequível a integração de um editor de características ao Dynagraph, que é um software extensível.	
%   É realizável a utilização do modelo proposto de agrupamentos em grafos dinâmicos em um ambiente Web.	
%   É possível a criação de um algoritmo capaz de sugerir agrupamentos naturais dinâmicos espaço-temporais de casos de doenças como dengue e chikungunya geolocalizados no tempo.
%   É possível a avaliação da acertividade da metodologia no tocante do monitoramento da evolução da doença.